...
data_filtering:
  counties:
    enabled: true
    source: "file"
    file: "/home/users/salilg/tabpfn_data_scarcity/notebooks/feature_investigation/output_preprocessed/high_coverage_county_list.csv"
  features:
    enabled: true
    source: "file"
    file: "/home/users/salilg/tabpfn_data_scarcity/notebooks/feature_investigation/output_preprocessed/high_coverage_features.csv"
```
...
**Solution**:
1. Check `feature_coverage_preprocessed.csv` for actual feature names
...
**Solution**:
1. Check `county_feature_matrix_preprocessed.csv` for available FIPS codes
